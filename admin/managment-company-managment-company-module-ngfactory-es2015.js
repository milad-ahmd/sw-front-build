...
class AddComponent {
    constructor(companyService, route, router) {
    ...
    ngOnInit() {
        this.route.queryParams.subscribe(params => {
            if (params['id']) {
                this.companyService.getOne(params['id']).subscribe((res) => {
    ...
    save() {
        this.companyService.edit(this.company).subscribe((res) => {
            if (res) {
                this.router.navigateByUrl('pages/company');
            }
        });
    }
    imageUpload(event) {
        if (event.target.files[0] && event.target.files[0].size <= 2048000) {
            ...
            let self = this;
            reader.onload = () => {
                self.company.avatar = reader.result.toString();
            };
        }
    }
}
...
class ListComponent {
    ...
    getCompanyPagination(page, filter) {
        this.companyService.getAll(page, filter).subscribe((res) => {
            this.count = res.totalDocs;
            this.companyList = res.docs;
        });
    }
    edit(_id) {
...
class ManagmentCompanyRoutingModule {
}
...
/* harmony import */ var _angular_cdk_platform__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/cdk/platform */ "./node_modules/@angular/cdk/esm2015/platform.js");
...
/* harmony import */ var _nebular_security__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @nebular/security */ "./node_modules/@nebular/security/fesm2015/index.js");
/* harmony import */ var _nebular_eva_icons__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @nebular/eva-icons */ "./node_modules/@nebular/eva-icons/fesm2015/index.js");
...
/* harmony import */ var angular_ng_autocomplete__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! angular-ng-autocomplete */ "./node_modules/angular-ng-autocomplete/fesm2015/angular-ng-autocomplete.js");
...
class CompanyService extends _serivce_base2_service__WEBPACK_IMPORTED_MODULE_1__["ServiceBase2"] {
...
//# sourceMappingURL=managment-company-managment-company-module-ngfactory-es2015.js.map