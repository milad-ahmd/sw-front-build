...
body, div, table, label, button, span, a, p, legend, input, pre {
...
.table-wrap {
  ...
  .table tbody tr:hover {
    background-color: rgba(210, 234, 253, 0.2);
    cursor: pointer;
  }
}
...
.btn-cancel {
  background-image: linear-gradient(to right, #bec2cd, #797f91)!important;
  border: none;
  box-shadow: 0 0 0 0 #9899db, 0 0 0 0 #6c73b8, 0 0 transparent!important;
  color: #ffffff;
}
