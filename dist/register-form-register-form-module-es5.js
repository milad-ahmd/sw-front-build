    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authService.login({ username: this.mobile, password: this.password }).subscribe(function (res) {
            if (res && res.access_token) {
                var notifyConfig = new _base_notify_notify_config__WEBPACK_IMPORTED_MODULE_5__["NotifyConfig"](_base_notify_notify__WEBPACK_IMPORTED_MODULE_4__["Notify"].Type.SUCCESS, _base_notify_notify__WEBPACK_IMPORTED_MODULE_4__["Notify"].Placement.TOP_LEFT, _base_notify_notify__WEBPACK_IMPORTED_MODULE_4__["Notify"].TEMPLATES.Template2, 'login successful!', '');
            ...
            var notifyConfig = new _base_notify_notify_config__WEBPACK_IMPORTED_MODULE_5__["NotifyConfig"](_base_notify_notify__WEBPACK_IMPORTED_MODULE_4__["Notify"].Type.DANGER, _base_notify_notify__WEBPACK_IMPORTED_MODULE_4__["Notify"].Placement.TOP_LEFT, _base_notify_notify__WEBPACK_IMPORTED_MODULE_4__["Notify"].TEMPLATES.Template2, 'incorrect username or password!', '');
            _base_notify_notify__WEBPACK_IMPORTED_MODULE_4__["Notify"].showNotify(notifyConfig);
        });
    };
